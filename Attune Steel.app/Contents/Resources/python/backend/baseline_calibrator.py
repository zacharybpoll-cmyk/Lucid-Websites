...
class BaselineCalibrator:
    ...
    def is_calibrated(self) -> bool:
        ...
        required_metrics = [
            ...
            'wellbeing_score', 'activation_score', 'calm_score'
        ]
    ...
    def update_baselines(self):
        ...
        metrics = [
            ...
            'stress_score', 'wellbeing_score', 'activation_score', 'calm_score',
            ...
            'alpha_ratio', 'mfcc3', 'pitch_range', 'rms_sd',
            'phonation_ratio', 'h1_h2', 'hnr', 'voice_tremor_index',
            'pause_mean', 'pause_sd', 'pause_rate',
        ]
